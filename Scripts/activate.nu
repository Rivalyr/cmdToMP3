...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'E:\Programacion\Python\webscrapiing\selenium\Proyecto Musica\YoutubeProject'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'E:\Programacion\Python\webscrapiing\selenium\Proyecto Musica\YoutubeProject\Scripts\deactivate.nu'
